  ...
  return (
    <div className="relative tw-flex tw-flex-col tw-w-[220px] tw-h-[254px] tw-bg-white tw-rounded-t-[15px] tw-rounded-bl-[15px] tw-shadow-lg">
      <div className='tw-h-[171px]'>
        <Image
          src="/images/homepage/hover/3.svg"
          width={274}
          height={171}
          alt="Shoes"
      ...
      <div className='tw-h-[101px] tw-space-y-[10px] tw-px-2'>
            <div className='tw-flex tw-items-center tw-space-x-[8px]'>
                ...
                alt="check-mark"
                />
                <div className='tw-text-[10px] tw-text-black tw-font-medium tw-text-left'>Halal-driven investment portfolios</div>
            </div>
            <div className='tw-flex tw-space-x-[8px]'>
                ...
                alt="check-mark"
                />
                <div className='tw-text-[10px] tw-text-black tw-font-medium tw-font-poppins tw-text-left'>Robin Habibi - Your personal broker</div>
            </div>
            <div className='tw-flex tw-space-x-[8px]'>
                <Image
                src={Images.bankCheck}
                ...
                alt="check-mark"
                />
                <div className='tw-text-[10px] tw-text-black tw-font-medium tw-text-left'>Start saving & investing effortlessly  via Round-ups feature</div>
            </div>
      </div>
    </div>
  )
