...
export default function Confetti() {
  ...
  return (
    <div className="thanks tw-max-h-full tw-transform tw-overflow-hidden tw-rounded-2xl tw-bg-white tw-p-6 tw-align-middle tw-shadow-xl tw-transition-all tw-mx-auto tw-my-auto">
        {/* close */}
        ...
        <div className="tw-absolute tw-bottom-0 tw-left-0">
