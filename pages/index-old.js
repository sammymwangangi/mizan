...
import HomePageNew from "../public/images/homepage/homepagenew.svg";
    ...
    <>
      ...
      <main className="landing-bg position-relative">
        ...
        <section className="cards position-relative">
          ...
          <Image src={cardMain} width="100%" className="card-web" alt="" />
          <Image
            src={cardMainTablet}
            width="100%"
        ...
        <section className="ups-work ">
          <div className="ups-box position-relative">
            <Image src={pattern} className="ups-bg" alt="" />
            <div className="row ">
            ...
            <div className="modal-body">
              ...
              <div className="mobile-menu-list mt-5">
                <ul>
                  ...
                  <li>
                    <a href="brand.html">Brand Story</a>
                  </li>
                </ul>
              </div>
      ...
      <Script id="">
          {`console.log('chat bot integration');
          window.__be = window.__be || {};
          window.__be.id = "63bd2e8a22ca620007fcf5eb";
          (function () {
