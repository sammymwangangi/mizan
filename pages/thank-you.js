...
export default function ThankYou() {
  ...
  return (
    <>
      <div className="tw-w-[1148px] tw-h-[645px] tw-max-h-full tw-transform tw-overflow-hidden tw-rounded-2xl tw-bg-white tw-p-6 tw-align-middle tw-shadow-xl tw-transition-all tw-mx-auto tw-my-auto">
        {/* close */}
