...
const testimonials = [
  {
    ...
    imageUrl: Images.ghazali,
    ratingImageUrl: Images.rating,
    description:
      "Allahmdoullilah, much awaited fully regulated shariah compliant islamic super app coming to Kenya.",
  },
  {
    id: "2",
    name: "Hadia",
